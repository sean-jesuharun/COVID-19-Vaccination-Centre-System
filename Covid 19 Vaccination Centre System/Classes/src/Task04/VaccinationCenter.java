...
public class VaccinationCenter {
        ...
        while (true) {
            ...
            if (VaccinationRequest == 1) {
                ...
                if (flag1) {
                    ...
                    waitingList.add(new Patient(FirstName, SurName, Age, City, NICorPassport, VaccinationRequest));
    ...
    private static void storeProgramDataIntoFile(){
        ...
        try {
            ...
            System.out.println("Patient Details have been Successfully Stored in \" patientFileTask4 \" TextFile...");
    ...
    private static void loadProgramDataFromFile(){
        ...
        try{
            ...
            System.out.println("Patient Details have been Successfully loaded from the \" patientFileTask4 \" TextFile...");
        }
